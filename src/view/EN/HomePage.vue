  ...
  <div id="HomePage">
      ...
      <div class="row bannerBox">
        ...
        >
          ...
          >
            ...
            />
            <div class="text_type" v-if="item.type == 1">News</div>
            <div v-else class="text_type">Events</div>
    ...
    <div id="bigData" class="container-fuild">
      <div class="row bigData-container">
        <div class="col-xs-12 col-sm-12 col-md-9 wow fadeIn">
          <div class="col-xs-12 col-sm-12 col-md-12 wow fadeIn">
            <div class="activity_newBox row">
          ...
          <div class="col-xs-12 col-sm-12 col-md-5 wow fadeIn">
            <a-spin :spinning="showLoading_events">
              <div class="newsBox">
                <div class="newsBox_header">
                  <p>Events</p>
                  <p @click="gotoActivity">more events</p>
                </div>
                <div class="newsBox_content">
                  <ul>
          ...
          <div id="products" class="container-fuild">
            <div class="row products-container products_box">
              ...
              <div
                ...
                :key="index"
              >
                <div class="productsBox" @click="gotoProductDetail(item.id)">
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 wow fadeIn">
          <h2 class="bigData-title">
            Greater International Development Organization
            <small>/ 中华国际地标发展组织</small>
          </h2>
          <p>
            "Geographical indications" are an important category of intellectual
            property rights in the world, a national name card for products,
            brands and cultures, and an important path choice for countries and
            regions around the world to develop the real economy and promote
            hunger and poverty reduction.
          </p>
          <p>
            China is the country with the largest number of geographical
            indication products in the world, with a total of 9,958, according
            to statistics; 4844 in the European Union, ranking second; the
            United States, 587, ranking 15th; Russia, 262, ranking 20th.
          </p>
          <div class="newsTop">
            <div class="hots_head">☞Hot</div>
            <div class="hots_list">
              <ul>
    ...
    <div id="contactUs" class="container-fuild text-center home_aboutBox">
      <div class="container contactUs-container wow fadeIn">
        <h1>Greater International Development Organization</h1>
        <h3>中华国际地标发展组织</h3>
        <button
...
export default {
  ...
  methods: {
      ...
      let mySwiper = new Swiper(".swiper-container", {
        ...
        on: {
          click: function () {
            ...
            that.$router.push({ path: "/EN/newsDetail", query: { id: id } });
          },
        },
        // 如果需要分页器
        pagination: {
    ...
    gotoActivityDetails(id) {
      this.$router.push({ path: "/EN/activityDetails", query: { id: id } });
    },
    gotoProduct() {
      this.$router.push({ path: "/EN/product" });
    },
