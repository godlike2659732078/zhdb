<template>
  <div id="productBox">
    <div class="banner container-fuild text-center">产品列表</div>
    <!-- 大数据管理系统 -->
        ...
        <div class="row productsData-container">
          ...
          <div class="col-xs-12 col-sm-12 col-md-3 wow fadeIn">
            <h2 class="productsData-title">
              地理标志产品
              <small>/ Geographical indication products</small>
            </h2>
            <p>
              地理标志产品，是指产自特定地域，所具有的质量、声誉或其他特性本质上取决于该产地的自然因素和人文因素，经审核批准以地理名称进行命名的产品。
            </p>
            <div class="cardBox">
              <p class="cardTitle">产品分类</p>
              <a-tag
                color="blue"
              ...
              <a-tag color="blue" @click="getALLProduct"> 全部 </a-tag>
            </div>
            <div class="cardBox">
              <p class="cardTitle">产品地区</p>
              <a-tag
                color="cyan"
              ...
              <a-tag color="cyan" @click="getAllReginProduct"> 全部 </a-tag>
            </div>
            <div class="newsTop">
              <div class="hots_head">☞热点产品</div>
              <div class="hots_list">
                <ul>
